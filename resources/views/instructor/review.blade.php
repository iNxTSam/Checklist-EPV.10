...
@section('title', 'Portal CEET - Revisar Estudiante')
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                ...
                <p class="header-subtitle">Regional Distrito Capital - Revisión de Documentos</p>
            </div>
            <div class="col-md-4 text-end">
                <a href="/instructor" class="btn btn-outline-light">
